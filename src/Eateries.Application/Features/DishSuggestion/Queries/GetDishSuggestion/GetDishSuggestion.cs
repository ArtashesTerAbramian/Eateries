...
namespace Eateries.Application.Features.DishSuggestion.Queries.GetDishSuggestion;
...
public class GetDishSuggestion : IRequest<Response<List<Dish>>>
{
    ...
    public class GetDishSuggestionHandler : IRequestHandler<GetDishSuggestion, Response<List<Dish>>>
    {
        ...
        {
            var suggestion =
                await _dishSuggestionAsync.SuggestFood(request.UserId, request.MenuId, request.numOfSuggestions);
